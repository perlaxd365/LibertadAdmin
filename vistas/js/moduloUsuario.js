$(document).ready(function(){
 $('.moduloUsuario').submit(function(e){
        e.preventDefault();
        ...
        var textoAlerta;
        if(tipo==="save"){
            textoAlerta="Los datos del usuario se registrarán en el sistema";
        }else if(tipo==="delete"){
            textoAlerta="Los datos serán eliminados completamente del sistema";
        }else if(tipo==="update"){
        	textoAlerta="Los datos del usuario serán actualizados";
        }else if(tipo==="login"){
        	textoAlerta="Iniciar Sessión";
        }else if(tipo==="buscar"){
        	textoAlerta="Quieres iniciar busqueda ?";
        }else{
